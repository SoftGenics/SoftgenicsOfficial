            ...
            <div className='home-container'>
                ...
                <div className='over-container-main' ref={overviewContainerRef}>
                    ...
                    <div className='over-rigth-container'>
                        <div className='over-description-container'>
                            ...
                            <h3 className='sub-heading'>At SoftGenics India Pvt Ltd</h3>
                            <p className='over-description'>
                             we pride ourselves on being a dynamic and client-centric service-based company that excels in delivering innovative solutions tailored to meet the unique needs of our clients. Our commitment to excellence, coupled with a relentless pursuit of cutting-edge technologies, has positioned us as a trusted partner for businesses seeking transformative digital solutions.</p>
                            <li className='li-classes'>Custom Software Development</li>
                            <li className='li-classes'>Web Application Development</li>
                            <li className='li-classes'>Mobile App Development</li>
                            <li className='li-classes'>Cloud Computing Solutions</li>
                            <p className='over-description' style={{ marginTop: "14px" }}> In essence, SoftGenics India Pvt Ltd is not merely a service provider; we are a strategic partner invested in the success of our clients. With a focus on innovation, reliability, and client satisfaction, we navigate the evolving landscape of technology to deliver solutions that propel businesses forward.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='background-card-container'>
                        <div className='home-card-container'>
                            ...
                            <div className='home-card-description'>
                                <h3 className='sub-heading' style={{ fontSize: "24px" }}>Application Server</h3>
                                <p className='over-description' style={{ fontSize: "17px", textAlign:"center" }}>
                        ...
                        <div className='home-card-container'>
                            ...
                            <div className='home-card-description'>
                                <h3 className='sub-heading' style={{ fontSize: "24px" , textAlign:"center"}}>web development company</h3>
                                <p className='over-description' style={{ textAlign: "center", fontSize: "17px" }}>
                                Softgenics is a leading web development company known for providing tailored solutions. Our team of experienced professionals ensures each project receives meticulous attention to detail and superior execution.</p>
                            </div>
                        </div>
                        ...
                        <div className='home-card-container'>
                            <img className='background-image' src={resurchImg} alt="resurchImg" />
                            <div className='home-card-description'>
                                <h3 className='sub-heading' style={{ fontSize: "24px", textAlign:"center" }}>Application Performance Monitoring</h3>
                                <p className='over-description' style={{ fontSize: "17px" , textAlign:"center"}}>
                                We provide robust monitoring tools to track application performance metrics and identify areas for improvement.</p>
                            </div>
                        </div>
                ...
                <div className='query-container-main' style={{ marginTop: "60px" }} ref={formContainerRef}>
                    <div className='query-discription'>
                        <p className='over-description' style={{ fontSize: "25px", textAlign: "center", fontWeight: "600" }}>
                            <br />
                            Leverage the Technical  
                            <br /> <br />
                            Expertise of A Top Web Development Company
                            <br /> <br />
                            to Own Innovative Web App Solutions
                            <br /> <br />
                            How can we help you?
                        </p>
                    </div>
