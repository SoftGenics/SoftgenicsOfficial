...
const DesignandDevServices = () => {
  ...
  return (
    <>
    <div className='services-cont' id='design' data-aos="zoo-in">
   
      <h1>Our Design and Development Services</h1>
    <Container >
      <Row data-aos="zoom-out">
        <Col md={3} mr-3>
        
        <Card data-aos="flip-up" style={{ width:'20rem',   height:'75%',borderRadius:'0.5em' ,transition:'all ease 200ms',overFlow: 'hidden'
        , margin: '1em'
  ...
  <Card.Body >
    ...
    We design website for you and host that over the server so that your business can be easily approachable from any where any time and it gives your business exist over internet. so we think you must have your own website.
        ...
        <Col md={3}>
        <Card data-aos="flip-down"  style={{ width:'20rem', height:'75%', borderRadius:'0.6em' ,transition:'all ease 200ms',overFlow: 'hidden'
        , margin: '1em'
      ,  boxShadow: '0 13px 27px -5px hsla(240, 30.1%, 28%, 0.25), 0 8px 16px -8px hsla(0, 0%, 0%, 0.3), 0 -6px 16px -6px hsla(0, 0%, 0%, 0.03)' }} >
  ...
  <Card.Body>
    ...
    <h2>_______________</h2>
    <Card.Text>
    Mobile application development is the set of processes and procedures involved in writing software for small, wireless computing devices, such as smartphones and other hand-held devices. Like web & mobile application development has its roots in more traditional software development.
    </Card.Text>
        ...
        <Col md={3}>
        <Card data-aos="flip-up"  style={{width:'20rem',  height:'75%', borderRadius:'0.6em' ,transition:'all ease 200ms',overFlow: 'hidden'
        , margin: '1em'
      ,  boxShadow: '0 13px 27px -5px hsla(240, 30.1%, 28%, 0.25), 0 8px 16px -8px hsla(0, 0%, 0%, 0.3), 0 -6px 16px -6px hsla(0, 0%, 0%, 0.03)' }} >
